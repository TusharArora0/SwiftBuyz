...
const ProductDetail = () => {
  ...
  useEffect(() => {
    const checkWishlistStatus = async () => {
      ...
      try {
        const response = await fetchWithAuth(`https://swiftbuyz-five.vercel.app/api/wishlist/check/${id}`);
        if (response.ok) {
  ...
  const fetchProductDetails = async () => {
    try {
      setLoading(true);
      const response = await fetch(`https://swiftbuyz-five.vercel.app/api/products/${id}`);
  ...
  const handleAddReview = async () => {
    try {
      const response = await fetch(`https://swiftbuyz-five.vercel.app/api/products/${id}/reviews`, {
        method: 'POST',
        headers: {
  ...
  const handleWishlistToggle = async () => {
    ...
    try {
      const response = await fetch(`https://swiftbuyz-five.vercel.app/api/wishlist/${id}`, {
