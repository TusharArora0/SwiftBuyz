...
const SellerProfile = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      // Fetch seller stats
      const statsResponse = await fetch(`https://swiftbuyz-five.vercel.app/api/products/seller/${user.id}/stats`, {
        headers
      });
      ...
      const productsResponse = await fetch(`https://swiftbuyz-five.vercel.app/api/products/seller/${user.id}`, {
        headers
      });
      ...
      // Fetch orders
      const ordersResponse = await fetch(`https://swiftbuyz-five.vercel.app/api/orders/seller/${user.id}`, {
        headers
      });
  ...
  const fetchSellerOrders = async () => {
    try {
      ...
      const response = await fetch(`https://swiftbuyz-five.vercel.app/api/orders/seller/${user._id}`, {
        headers: {
          'Authorization': `Bearer ${token}`
        }
      });
  ...
  const handleProductSubmit = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch('https://swiftbuyz-five.vercel.app/api/products', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleProductUpdate = async () => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`https://swiftbuyz-five.vercel.app/api/products/${productData._id}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleWishlistToggle = async (productId) => {
    try {
      const response = await fetch(`https://swiftbuyz-five.vercel.app/api/products/${productId}/wishlist`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`
        }
  ...
  const handleOrderStatusChange = async (orderId, newStatus, currentStatus) => {
    ...
    try {
      const response = await fetch(`https://swiftbuyz-five.vercel.app/api/orders/${orderId}/status`, {
        method: 'PATCH',
          headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
